<template>
	<div class="system-predict-container layout-padding" id="id" v-loading="state.loading">
		<div class="system-predict-padding layout-padding-auto layout-padding-view">
			<div class="carousel">
				<div class="section-title"><i></i><span>安全帽检测</span></div>
			</div>
			<div class="header">
				<div class="weight">
				...
				<div class="conf" style="margin-left: 20px;display: flex; flex-direction: row;">
					<div
						style="font-size: 14px;margin-right: 20px;display: flex;justify-content: start;align-items: center;color: #4CAF50;">
						设置最小置信度阈值</div>
				...
				<div class="button-section" style="margin-left: 20px">
					<el-button type="primary" @click="() => htmlToPDF('id', '安全帽检测报告')"
			...
			<div class="carousel">
				<div class="section-title"><i></i><span>AI分析</span></div>
			</div>
			<div style="width: 100%; margin-bottom: 20px; padding: 0 100px; display: flex; justify-content: center;">
				<div v-if="state.predictionResult.suggestion"
					 style="width: 100%; max-width: 900px; padding: 20px 40px; border-radius: 10px; min-height: 50px; border: 1px solid #4CAF50; background: #fff;">
