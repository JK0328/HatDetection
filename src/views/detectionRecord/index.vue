	...
	<div class="system-role-container layout-padding">
		<div class="system-role-padding layout-padding-auto layout-padding-view">
			...
			<el-table :data="state.tableData.data" v-loading="state.tableData.loading" style="width: 100%">
				...
				<el-table-column prop="helmet" label="头盔佩戴情况" show-overflow-tooltip width="150" align="center"></el-table-column>
				<el-table-column prop="licensePlate" label="车牌号码" show-overflow-tooltip width="150" align="center"></el-table-column>
				<el-table-column prop="detectionTime" label="检测时间" show-overflow-tooltip align="center"></el-table-column>
				<el-table-column prop="detectionAddress" label="检测地点" show-overflow-tooltip align="center"></el-table-column>
